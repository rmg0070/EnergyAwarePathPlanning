...
def executeIPP_py(scenario_number,N=6,resolution=0.1, number_of_iterations=20, save_fig_flag=True,):
    ...
    # Assume 'iteration' already accounts for the exact number of iterations completed (1-based index)
# If iteration = 34, it means iterations 0 to 33 (34 total) have been completed
# Adjust array slicing to match this documentation
    ...
    weights_plot = weights_plot[:iteration]
    updated_weights_plot = updated_weights_plot[:iteration]
